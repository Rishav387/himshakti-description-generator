...
export default function Hero() {
  return (
    <section className="bg-earth-50 dark:bg-earth-900 overflow-hidden relative transition-colors">
      {/* Decorative circle */}
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 py-20 md:py-28 relative">
        <div className="max-w-2xl">
          ...
          {/* Subheadline */}
          <p className="text-lg text-earth-700 dark:text-earth-200 leading-relaxed mb-10 max-w-xl">
